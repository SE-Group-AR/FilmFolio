...
<img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/recommend_mechanism.gif" width="600" height="375">

### Email Notifier
**The user sends his/her movies feedback via an email (Notify Me button)**
  
<div style="display: flex; justify-content: space-between;">
    <img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/email_notifier.gif" alt="Email Notifier" width="600" height="375">
    <img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/email.png" alt="Email" width="400" height="400">
</div>

### Create an Account
#### (NEW in project 3)
**Users can now create accounts, persisting data including their movie reviews and recommendations**
<img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/create_account.gif" width="600" height="375">

### Login to account
#### (NEW in project 3)
**The user can log in to their account securly with encrypted passwords stored in our database**
<img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/login.gif" width="600" height="375">

### Profile and Friends
#### (NEW in project 3)
**The user can add friends, view the movies reviewed by the friends, and see their reviewed movies in their profile**
<img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/profile.gif" width="600" height="375">

### Wall
#### (NEW in project 3)
**The user can interact with other users, by viewing a community sourced wall of recent moview reviews**
<img src="https://github.com/sE-Group-AR/FilmFolio/blob/master/asset/wall.gif" width="600" height="375">

## Project 3 Delta
Check out the significant changes that we made for Project 3 [here](https://github.com/sE-Group-AR/FilmFolio/blob/master/proj3/Proj3Changes.md)

Our grading scorecard can be found [here](https://github.com/sE-Group-AR/FilmFolio/blob/master/proj3/README.md)
...
<table>
  <tr>
    ...
    <td align="center"><a href="https://github.com/se-group-ar/"><img src="https://avatars.githubusercontent.com/u/144480335?v=4" width="75px;" alt=""/><br /><sub><b>Brandon Walia</b></sub></a></td>
